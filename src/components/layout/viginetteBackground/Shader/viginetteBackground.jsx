/* 
  ...
  Reference: https://github.com/mattdesl/three-vignette-background
*/
...
export default function ViginetteBackground() {
  let background = createBackground()
  background.style({
    // colors: ['#fff', '#283844'],
    colors: [
      new THREE.Color('hsl(176, 76%, 25%)'),
      new THREE.Color('hsl(322, 64%, 55%)'),
    ],
    scale: 1.5,
    aspect: 1.25,
    grainScale: 0.0001,
  ...
  let mesh = new THREE.Mesh(background.geometry, background.material)
